...
public class Banco extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("INSERT INTO questoes (_id, pergunta, resposta_correta, resposta_incorreta_a, resposta_incorreta_b, resposta_incorreta_c) SELECT 15,'Goku foi um...','Personagem de um anime','grande guerreio','saijin Deus','Grande rival de vegeta' WHERE NOT EXISTS ( SELECT 1 FROM questoes WHERE _id = 14 );");
        ...
        db.execSQL("INSERT INTO questoes (_id, pergunta, resposta_correta, resposta_incorreta_a, resposta_incorreta_b, resposta_incorreta_c) SELECT 17,'Ganhador do Nobel de Química de 1996 é...','Robert Curl','James Dewar','Otto Hahn','Paul Karrer' WHERE NOT EXISTS ( SELECT 1 FROM questoes WHERE _id = 16 );");
        db.execSQL("INSERT INTO questoes (_id, pergunta, resposta_correta, resposta_incorreta_a, resposta_incorreta_b, resposta_incorreta_c) SELECT 18,'O que foi inuyasha um(a)...','Anime','Música','Shopping do Japão','Banda' WHERE NOT EXISTS ( SELECT 1 FROM questoes WHERE _id = 17 );");
        db.execSQL("INSERT INTO questoes (_id, pergunta, resposta_correta, resposta_incorreta_a, resposta_incorreta_b, resposta_incorreta_c) SELECT 19,'Qual a massa atômica do hidrogênio?','1','3','8','4' WHERE NOT EXISTS ( SELECT 1 FROM questoes WHERE _id = 18 );");
